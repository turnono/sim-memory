...
from sim_guide.services import (
    ...
    analyze_user_message_for_preferences, format_preferences_summary,
...
async def test_preference_detection():
    ...
    try:
        ...
        for i, test_case in enumerate(test_messages):
            ...
            updated_prefs = analyze_user_message_for_preferences(test_case['message'], session_state)
            ...
            expected_met = any(change in changes_detected for change in test_case['expected_changes'])
            ...
            if expected_met:
                ...
                print(f"    ❌ Expected: {test_case['expected_changes']}, Got: {changes_detected}")
...
async def test_preference_tools():
    ...
    try:
        ...
        initial_success = isinstance(initial_result, str) and not initial_result.startswith("Error:")
        ...
        name_success = isinstance(set_name_result, str) and "Successfully updated" in set_name_result
        ...
        exp_success = isinstance(set_exp_result, str) and "Successfully updated" in set_exp_result
        print(f"  🎓 Set life experience level result: {exp_success}")
        
        # Get final preferences to verify
        final_result = get_user_preferences()
        final_success = isinstance(final_result, str) and not final_result.startswith("Error:")
    ...
    try:
        ...
        for profile in test_profiles:
            ...
            if context:
                ...
                keywords_found = sum(1 for keyword in profile['expected_keywords'] 
