...
def after_agent_callback(callback_context: CallbackContext) -> Optional[types.Content]:
    ...
    try:
        ...
        if hasattr(callback_context, 'state') and 'processing_start_time' in callback_context.state:
            start_time = datetime.fromisoformat(callback_context.state['processing_start_time'])
