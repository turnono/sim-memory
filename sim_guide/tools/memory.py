...
def load_life_resources(resource_type: str = "general") -> str:
    ...
    try:
        ...
        resource_map = {
            ...
            "relationships": ["communication guides", "relationship advice", "conflict resolution"],
            "health": ["wellness plans", "fitness guides", "mental health resources"],
            "finance": ["budgeting templates", "investment guides", "financial planning"],
            "personal_growth": ["self-improvement guides", "skill development", "learning resources"],
            "productivity": ["time management", "organization systems", "productivity tools"],
            "creativity": ["creative exercises", "inspiration guides", "artistic development"],
            "social": ["networking guides", "social skills", "communication tips"],
            "spirituality": ["mindfulness guides", "purpose exploration", "meaning frameworks"],
        ...
        resources_to_load = resource_map.get(resource_type, ["life guidance", "goal setting"])
        ...
        if loaded_resources:
            ...
            return f"Attempted to load resources for: {', '.join(resources_to_load[:3])}"
