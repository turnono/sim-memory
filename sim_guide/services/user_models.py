...
class UserPreferences:
    ...
    life_stage: Optional[str] = None  # "student", "early_career", "parent", "retired", etc.
    ...
    preference_confidence: Dict[str, float] = None  # Confidence scores for auto-detected preferences
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'UserPreferences':
        ...
        if 'life_experience_level' in data:
            data['life_experience_level'] = LifeExperienceLevel(data['life_experience_level'])
